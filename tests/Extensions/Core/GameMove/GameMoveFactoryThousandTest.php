...
class GameMoveFactoryThousandTest extends TestCase
{
    ...
    public function testThrowExceptionWhenPhaseKeyMissing(): void
    {
        ...
        GameMoveFactoryThousand::create($this->player, []);
    }
    ...
    public function testThrowExceptionWhenPhaseKeyEmpty(): void
    {
        ...
        GameMoveFactoryThousand::create($this->player, ['phase' => '']);
    }
    ...
    public function testThrowExceptionWhenPhaseKeyNotSortingAndNotExist(): void
    {
        ...
        GameMoveFactoryThousand::create($this->player, ['phase' => 'something-definitely-wrong']);
    }
    ...
    public function testThrowExceptionWhenInputsDataMissing(): void
    {
        ...
        GameMoveFactoryThousand::create($this->player, ['phase' => 'sorting']);
    }
    ...
    public function testThrowExceptionWhenInputsDataNotArray(): void
    {
        ...
        GameMoveFactoryThousand::create($this->player, ['phase' => 'sorting', 'data' => 'not-array']);
    }

    public function testCreateGameMoveThousandSorting(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'sorting', 'data' => ['hand' => ['123', '234']]]);
        $this->assertInstanceOf(GameMoveThousandSorting::class, $move);
    }

    public function testCreateGameMoveThousandBidding(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'bidding', 'data' => ['decision' => 'bid', 'bidAmount' => 110]]);
        $this->assertInstanceOf(GameMoveThousandBidding::class, $move);
    }

    public function testCreateGameMoveThousandStockDistribution(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'stock-distribution', 'data' => ['distribution' => ['playerX' => '123', 'playerY' => '234']]]);
    ...
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'declaration', 'data' => ['declaration' => 200]]);
        $this->assertInstanceOf(GameMoveThousandDeclaration::class, $move);
    }

    public function testCreateGameMovePlayCardPhase1(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'playing-first-card', 'data' => ['card' => '123']]);
        $this->assertInstanceOf(GameMoveThousandPlayCard::class, $move);
    }

    public function testCreateGameMovePlayCardPhase2(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'playing-second-card', 'data' => ['card' => '123']]);
        $this->assertInstanceOf(GameMoveThousandPlayCard::class, $move);
    }

    public function testCreateGameMovePlayCardPhase3(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'playing-third-card', 'data' => ['card' => '123']]);
        $this->assertInstanceOf(GameMoveThousandPlayCard::class, $move);
    }

    public function testCreateGameMoveCollectTricks(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'collecting-tricks', 'data' => ['collect' => true]]);
        $this->assertInstanceOf(GameMoveThousandCollectTricks::class, $move);
    }

    public function testCreateGameMoveThousandCountPoints(): void
    {
        $move = GameMoveFactoryThousand::create($this->player, ['phase' => 'counting-points', 'data' => ['ready' => true]]);
